...
@HippoEssentialsGenerated(internalName = "pactronics:contentdocument")
@Node(jcrType = "pactronics:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    @JsonIgnore
    @HippoEssentialsGenerated(internalName = "pactronics:publicationdate", allowModifications = false)
