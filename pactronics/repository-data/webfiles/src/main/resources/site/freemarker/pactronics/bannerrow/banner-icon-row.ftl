...
<div class="bloomreach">
    <div id="banner-main" class="row display-inline text-center">
        <div id="banner" class="span_4 column">
            <@printIcons document=document1 showContent=showContent />
        </div>
        <div id="banner1" class="span_4 column">
            <@printIcons document=document2 showContent=showContent index=1 />
        </div>
        <div id="banner2" class="span_4 column">
            <@printIcons document=document3 showContent=showContent index=2 />
        </div>
    </div>
</div>
